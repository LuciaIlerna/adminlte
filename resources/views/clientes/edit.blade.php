...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="text-dark">
                <i class="fas fa-user-edit text-success"></i> Editar Cliente
            </h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card card-success card-outline elevation-3">
                ...
                <div class="card-body">
                    <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" class="needs-validation" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        @if($cliente->foto)
                            <div class="form-group mb-3">
                                <label class="form-label font-weight-bold">
                                    <i class="fas fa-image text-success"></i> Foto Actual
                                </label>
                                <div>
                                    <img src="{{ asset('storage/' . $cliente->foto) }}" alt="Foto" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-group mb-4">
                            <label for="foto" class="form-label font-weight-bold">
                                <i class="fas fa-image text-success"></i> Cambiar Foto
                            </label>
                            ...
                            <small class="form-text text-muted">Máximo 2MB. Formatos: JPG, PNG, GIF (dejar vacío para mantener la foto actual)</small>
